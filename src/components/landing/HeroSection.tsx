...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-[100dvh] min-h-[100svh] overflow-hidden pt-[max(6.5rem,calc(5rem+env(safe-area-inset-top,0px)))] sm:pt-28">
      ...
      <div className="relative mx-auto grid max-w-6xl gap-8 px-4 pb-16 pt-6 sm:gap-10 sm:px-6 sm:pt-8 lg:grid-cols-2 lg:items-center lg:gap-12 lg:pb-24">
        <div>
          ...
          <motion.p
            ...
            className="mt-6 max-w-xl text-lg text-ink/70 dark:text-ink/65"
          >
          ...
          >
            <Link
              href="#campus"
              className="inline-flex min-h-11 items-center justify-center rounded-2xl bg-ink px-6 py-3.5 text-sm font-bold text-cream shadow-xl shadow-ink/25 transition hover:scale-[1.02] active:scale-[0.98] dark:shadow-black/50"
            >
              {t.hero.ctaCampus}
            </Link>
            <Link
              href="#contacto"
              className="glass-panel inline-flex min-h-11 items-center justify-center rounded-2xl px-6 py-3.5 text-sm font-bold text-ink transition hover:bg-white/70 active:bg-white/90 dark:hover:bg-white/10"
            >
              {t.hero.ctaAdmission}
            </Link>
          </motion.div>
          <motion.div
            ...
            className="mt-10 flex flex-wrap gap-6 text-sm text-ink/60 dark:text-ink/55"
          >
            <div>
              <p className="font-display text-2xl font-bold text-ink">2</p>
              <p>{t.hero.statCampuses}</p>
            </div>
            <div className="hidden h-10 w-px bg-ink/10 sm:block dark:bg-ink/20" />
            <div>
              <p className="font-display text-2xl font-bold text-ink">360°</p>
              <p>{t.hero.statTours}</p>
            </div>
            <div className="hidden h-10 w-px bg-ink/10 sm:block dark:bg-ink/20" />
            <div>
              <p className="font-display text-2xl font-bold text-ink">IA+</p>
              <p>{t.hero.statMarketing}</p>
            </div>
          </motion.div>
        </div>
